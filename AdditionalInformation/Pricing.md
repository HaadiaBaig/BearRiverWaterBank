...
Cost per acft = $$\frac{\$ \  1 , 000 , 0 0 0 \  \ }{2500 * 5 \  a c f t} = \$ \mathbf{8 0 \  a c f t}$$

Assuming a lease for 10 years

Cost per acft = $$\frac{\$ \  1 , 000 , 0 0 0 \  \ }{2500 * 1 0 \  a c f t} = \$ \mathbf{4 0 \  a c f t}$$
...
Cost per acft = $$\frac{\$ \  4 , 000 , 0 0 0 \  \ }{22 , 0 0 0 \  a c f t} = \sim \$ \mathbf{\  1 7 8 \  a c f t}$$
